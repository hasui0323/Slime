...
public class FEffectItem : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        if (player.hasHeart)
            ItemUI.ShowItemInfo(player.HeartCount + " 回");

        else if (player.hasHeaven)
            ItemUI.ShowItemInfo(player.HeavenCount + " 回");

        else if (player.hasNoSkill)
            ItemUI.ShowItemInfo(player.NoSkillCount + " 回");

        else if (player.hasInvincibl)
            ItemUI.ShowItemInfo(InvinciblTime + " 秒");

        else if (player.hasTimeReset)
            ItemUI.ShowItemInfo( RemoveCoolTime + " 秒");
    }
